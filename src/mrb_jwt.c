...
static mrb_value mrb_jwt_add_grants(mrb_state *mrb, mrb_value self)
{
	...
	*/
	jwt_add_grants_json(data->jwt, json);
	return mrb_nil_value();
}
...
void mrb_mruby_libjwt_gem_init(mrb_state *mrb)
{
	...
	mrb_define_const(mrb, jwt, "ALG_NONE", mrb_fixnum_value(JWT_ALG_NONE));
	mrb_define_const(mrb, jwt, "ALG_HS256",  mrb_fixnum_value(JWT_ALG_HS256));
	mrb_define_const(mrb, jwt, "ALG_HS384",  mrb_fixnum_value(JWT_ALG_HS384));
	mrb_define_const(mrb, jwt, "ALG_HS512",  mrb_fixnum_value(JWT_ALG_HS512));
	mrb_define_const(mrb, jwt, "ALG_RS256",  mrb_fixnum_value(JWT_ALG_RS256));
	mrb_define_const(mrb, jwt, "ALG_RS384",  mrb_fixnum_value(JWT_ALG_RS384));
	mrb_define_const(mrb, jwt, "ALG_RS512",  mrb_fixnum_value(JWT_ALG_RS512));
	mrb_define_const(mrb, jwt, "ALG_ES256",  mrb_fixnum_value(JWT_ALG_ES256));
	mrb_define_const(mrb, jwt, "ALG_ES384",  mrb_fixnum_value(JWT_ALG_ES384));
	mrb_define_const(mrb, jwt, "ALG_ES512",  mrb_fixnum_value(JWT_ALG_ES512));
	DONE;
}
